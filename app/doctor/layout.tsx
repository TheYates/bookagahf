...
import { CalendarDays, Clock, Settings, LogOut, Menu, X, Bell } from "lucide-react"
import { cn } from "@/lib/utils"
import { supabaseBrowserClient } from "@/lib/supabase/client"

const NAV = [
  { href: "/doctor", label: "Appointments", icon: CalendarDays },
    ...
    <div className="flex min-h-svh bg-muted/20">
      ...
      >
        <div className="flex h-16 items-center gap-3 border-b px-4">
          <Image src="/agahflogo.svg" alt="AGAHF" width={32} height={32} className="block shrink-0 dark:hidden" priority />
          <Image src="/agahflogo-white.png" alt="AGAHF" width={32} height={32} className="hidden shrink-0 dark:block" priority />
          <div className="min-w-0">
            <p className="truncate text-xs text-muted-foreground">AGAHF</p>
            <p className="truncate text-sm font-bold leading-tight">Doctor Portal</p>
          </div>
          <button onClick={() => setSidebarOpen(false)} className="ml-auto shrink-0 lg:hidden">
